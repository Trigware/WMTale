...
@onready var textRenderer = get_node("/root/Legend/Text")
...
var bigTexturePanels := [3, 4, 5, 6, 7]
var scrollTween = create_tween()

func _ready():
	textRenderer.position.y = 385
...
func show_next_panel():
	...
	print(currentPanelTextureIndex)
	...
	if currentPanelTextureIndex in bigTexturePanels:
		fill_entire_screen()
		return
